    ...
    return (
        <>
            <div className='flex flex-col items-center justify-center'>
                <h1 className='text-4xl md:text-6xl font-bold mb-10 text-center text-gray-800'>Local Highlights</h1>
                <div className='cards flex w-full md:w-[80%] justify-between items-center py-8'>
